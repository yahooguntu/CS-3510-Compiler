...
(FUNCTION  printInt  [(int r)]
  ...
  (BB 15
    (OPER 69 Mov [(r 49)]  [(i 1)])
    (OPER 70 EQ [(r 48)]  [(r 4)(r 49)])
    (OPER 68 BEQ []  [(r 48)(i 0)(bb 18)])
  )
  (BB 17
    (OPER 71 Mov [(r 51)]  [(i 0)])
    (OPER 72 Pass []  [(r 51)])
    (OPER 73 JSR []  [(s putDigit)])
    (OPER 74 Mov [(r 52)]  [(m RetReg)])
  )
  (BB 18
  )
  (BB 5
  ...
  (BB 11
    (OPER 56 Mov [(r 40)]  [(i 10)])
    (OPER 57 GTE [(r 39)]  [(r 1)(r 40)])
    (OPER 55 BEQ []  [(r 39)(i 0)(bb 15)])
  )
  (BB 14
    (OPER 58 Mov [(r 43)]  [(i 10)])
    (OPER 59 Div_I [(r 42)]  [(r 1)(r 43)])
    (OPER 60 Mov [(r 3)]  [(r 42)])
    (OPER 61 Pass []  [(r 3)])
    (OPER 62 JSR []  [(s putDigit)])
    (OPER 63 Mov [(r 44)]  [(m RetReg)])
    (OPER 64 Mov [(r 47)]  [(i 10)])
    (OPER 65 Mul_I [(r 46)]  [(r 3)(r 47)])
    (OPER 66 Sub_I [(r 45)]  [(r 1)(r 46)])
    (OPER 67 Mov [(r 1)]  [(r 45)])
  )
  (BB 16
    (OPER 75 Pass []  [(r 1)])
    (OPER 76 JSR []  [(s putDigit)])
    (OPER 77 Mov [(r 53)]  [(m RetReg)])
    (OPER 78 Jmp []  [(bb 6)])
  )
)
(FUNCTION  main  []
  ...
  (BB 13
    (OPER 133 Mov [(r 86)]  [(i 10)])
    (OPER 134 EQ [(r 85)]  [(r 6)(r 86)])
    (OPER 132 BEQ []  [(r 85)(i 0)(bb 24)])
  )
  (BB 23
    (OPER 135 Mov [(r 88)]  [(i 99)])
    (OPER 136 Pass []  [(r 88)])
    (OPER 137 JSR []  [(s putchar)])
    (OPER 138 Mov [(r 89)]  [(m RetReg)])
    (OPER 139 Mov [(r 90)]  [(i 0)])
    (OPER 140 Pass []  [(r 90)])
    (OPER 141 JSR []  [(s putDigit)])
    (OPER 142 Mov [(r 91)]  [(m RetReg)])
    (OPER 143 Mov [(r 92)]  [(i 0)])
    (OPER 144 Pass []  [(r 92)])
    (OPER 145 JSR []  [(s putDigit)])
    (OPER 146 Mov [(r 93)]  [(m RetReg)])
    (OPER 147 Mov [(r 94)]  [(i 108)])
    (OPER 148 Pass []  [(r 94)])
    (OPER 149 JSR []  [(s putchar)])
    (OPER 150 Mov [(r 95)]  [(m RetReg)])
  )
  (BB 25
    (OPER 171 Mov [(r 106)]  [(i 10)])
    (OPER 172 Pass []  [(r 106)])
    (OPER 173 JSR []  [(s putchar)])
    (OPER 174 Mov [(r 107)]  [(m RetReg)])
    (OPER 175 Mov [(r 108)]  [(i 0)])
    (OPER 176 Mov [(m RetReg)]  [(r 108)])
    (OPER 177 Jmp []  [(bb 1)])
  )
  (BB 1
    (OPER 1 Func_Exit []  [])
  ...
  (BB 21
    (OPER 126 Mov [(r 82)]  [(i 3)])
    (OPER 127 Mov [(r 6)]  [(r 82)])
    (OPER 128 Jmp []  [(bb 22)])
  )
  (BB 18
  ...
  (BB 20
    ...
    (OPER 122 Mov [(r 79)]  [(i 84)])
    (OPER 123 Pass []  [(r 79)])
    (OPER 124 JSR []  [(s putchar)])
    (OPER 125 Mov [(r 80)]  [(m RetReg)])
  )
  (BB 22
  )
  (BB 15
  ...
  (BB 12
    (OPER 129 Mov [(r 84)]  [(i 0)])
    (OPER 130 Mov [(r 6)]  [(r 84)])
    (OPER 131 Jmp []  [(bb 13)])
  )
  (BB 24
    (OPER 151 Mov [(r 97)]  [(i 98)])
    (OPER 152 Pass []  [(r 97)])
    (OPER 153 JSR []  [(s putchar)])
    (OPER 154 Mov [(r 98)]  [(m RetReg)])
    (OPER 155 Mov [(r 99)]  [(i 97)])
    (OPER 156 Pass []  [(r 99)])
    (OPER 157 JSR []  [(s putchar)])
    (OPER 158 Mov [(r 100)]  [(m RetReg)])
    (OPER 159 Mov [(r 101)]  [(i 100)])
    (OPER 160 Pass []  [(r 101)])
    (OPER 161 JSR []  [(s putchar)])
    (OPER 162 Mov [(r 102)]  [(m RetReg)])
    (OPER 163 Mov [(r 103)]  [(i 61)])
    (OPER 164 Pass []  [(r 103)])
    (OPER 165 JSR []  [(s putchar)])
    (OPER 166 Mov [(r 104)]  [(m RetReg)])
    (OPER 167 Pass []  [(r 6)])
    (OPER 168 JSR []  [(s printInt)])
    (OPER 169 Mov [(r 105)]  [(m RetReg)])
    (OPER 170 Jmp []  [(bb 25)])
  )
)
