...
(FUNCTION  main  []
  ...
  (BB 13
    (OPER 129 Mov [(r 84)]  [(i 10)])
    (OPER 130 EQ [(r 83)]  [(r 6)(r 84)])
    (OPER 128 BEQ []  [(r 83)(i 0)(bb 24)])
  )
  (BB 23
    (OPER 131 Mov [(r 86)]  [(i 99)])
    (OPER 132 Pass []  [(r 86)])
    (OPER 133 JSR []  [(s putchar)])
    (OPER 134 Mov [(r 87)]  [(m RetReg)])
    (OPER 135 Mov [(r 88)]  [(i 0)])
    (OPER 136 Pass []  [(r 88)])
    ...
    (OPER 143 Mov [(r 92)]  [(i 108)])
    (OPER 144 Pass []  [(r 92)])
    (OPER 145 JSR []  [(s putchar)])
    (OPER 146 Mov [(r 93)]  [(m RetReg)])
  )
  (BB 25
    (OPER 167 Mov [(r 104)]  [(i 10)])
    (OPER 168 Pass []  [(r 104)])
    (OPER 169 JSR []  [(s putchar)])
    (OPER 170 Mov [(r 105)]  [(m RetReg)])
    (OPER 171 Mov [(r 106)]  [(i 0)])
    (OPER 172 Mov [(m RetReg)]  [(r 106)])
    (OPER 173 Jmp []  [(bb 1)])
  )
  (BB 1
    (OPER 1 Func_Exit []  [])
