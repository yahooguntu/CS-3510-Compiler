...
(FUNCTION  main  []
  ...
  (BB 13
    (OPER 135 Mov [(r 86)]  [(i 10)])
    (OPER 136 EQ [(r 85)]  [(r 6)(r 86)])
    (OPER 134 BEQ []  [(r 85)(i 0)(bb 24)])
  )
  (BB 23
    (OPER 137 Mov [(r 88)]  [(i 99)])
    (OPER 138 Pass []  [(r 88)])
    ...
    (OPER 145 Mov [(r 92)]  [(i 0)])
    (OPER 146 Pass []  [(r 92)])
    (OPER 147 JSR []  [(s putDigit)])
    (OPER 148 Mov [(r 93)]  [(m RetReg)])
    (OPER 149 Mov [(r 94)]  [(i 108)])
    (OPER 150 Pass []  [(r 94)])
    (OPER 151 JSR []  [(s putchar)])
    (OPER 152 Mov [(r 95)]  [(m RetReg)])
  )
  (BB 25
    (OPER 173 Mov [(r 106)]  [(i 10)])
    (OPER 174 Pass []  [(r 106)])
    (OPER 175 JSR []  [(s putchar)])
    (OPER 176 Mov [(r 107)]  [(m RetReg)])
    (OPER 177 Mov [(r 108)]  [(i 0)])
    (OPER 178 Mov [(m RetReg)]  [(r 108)])
    (OPER 179 Jmp []  [(bb 1)])
  )
  (BB 1
    (OPER 1 Func_Exit []  [])
  ...
  (BB 12
    (OPER 131 Mov [(r 84)]  [(i 0)])
    (OPER 132 Mov [(r 6)]  [(r 84)])
    (OPER 133 Jmp []  [(bb 13)])
  )
  (BB 24
    (OPER 153 Mov [(r 97)]  [(i 98)])
    (OPER 154 Pass []  [(r 97)])
    (OPER 155 JSR []  [(s putchar)])
    (OPER 156 Mov [(r 98)]  [(m RetReg)])
    (OPER 157 Mov [(r 99)]  [(i 97)])
    (OPER 158 Pass []  [(r 99)])
    (OPER 159 JSR []  [(s putchar)])
    (OPER 160 Mov [(r 100)]  [(m RetReg)])
    (OPER 161 Mov [(r 101)]  [(i 100)])
    (OPER 162 Pass []  [(r 101)])
    (OPER 163 JSR []  [(s putchar)])
    (OPER 164 Mov [(r 102)]  [(m RetReg)])
    (OPER 165 Mov [(r 103)]  [(i 61)])
    (OPER 166 Pass []  [(r 103)])
    (OPER 167 JSR []  [(s putchar)])
    (OPER 168 Mov [(r 104)]  [(m RetReg)])
    (OPER 169 Pass []  [(r 6)])
    (OPER 170 JSR []  [(s printInt)])
    (OPER 171 Mov [(r 105)]  [(m RetReg)])
    (OPER 172 Jmp []  [(bb 25)])
  )
)
